...
- Nessa aula serão apresentadas as principais medidas de variabiliade. Medidas de variabilidade indicam o quanto os dados se dispersam em relação à média ou entre si. As principais medidas incluem o desvio padrão, a variância e o coeficiente de variáção, que ajudam a entender a distribuição e a consistência dos dados.
